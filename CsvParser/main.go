...
func main() {
	...
	for i := 0; i < len(incidentArray); i++ {
		fmt.Printf("%d ", i)
		fmt.Printf(incidentArray[i].GetLocation())
		fmt.Printf("\n")
		fmt.Printf(incidentArray[i].GetASN())
		fmt.Printf("\n")
		placeIncidentInFileStruct("/Users/clinc1920/Music/file_mount", incidentArray[i])
	}
}